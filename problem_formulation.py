...
def guaranteed95_over(*args):           #Oscar added
    ...
    return np.quantile(numbers, q=0.05)

def guaranteed98_over(*args):           #Oscar added
    numbers = []
    for entry in args[0]:
        try:
            numbers.extend(entry)
    ...
    return np.quantile(numbers, q=0.02)
